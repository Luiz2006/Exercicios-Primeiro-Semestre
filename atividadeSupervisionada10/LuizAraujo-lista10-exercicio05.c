...
#include<stdlib.h>
#include<locale.h>
////há funções para fazer entradas aleatórias um pouco mais aleatórios que o rand();
...
//resultado
	...
	printf("\nAPROVEITAMENTO: %.2f%%.", (media*10));
//	printf("\nFREQUÊNCIA    : %.2f %%.", frequencia);
//	mensagemResultado(media, avaliacao1, avaliacao2, avaliacao3);
...
void validarFrequencia(float *aula, float total){ 	
	...
	while((*aula < 0)||(*aula > 99)){
		if(cont > 1){
			printf("Informe algo entre 1 e 99.\n");
		}
