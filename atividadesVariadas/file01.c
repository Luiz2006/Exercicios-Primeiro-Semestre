...
int main(void){
	...
	if(!(arq = fopen("G:\\GitHub\\Exercicios-Primeiro-Semestre\\atividadeSupervisionada02\\arq\\arq1.txt", "w"))){
			printf("Erro! \n");
	}else{
	...
	if(!(arq = fopen("G:\\GitHub\\Exercicios-Primeiro-Semestre\\atividadeSupervisionada02\\arq\\arq1.txt", "r"))){
